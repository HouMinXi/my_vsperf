...
class IVnfQemu(IVnf):
    ...
    def _configure_testpmd(self):
        ...
        #self.execute_and_wait('echo 0 > /proc/sys/kernel/nmi_watchdog')
        #self.execute_and_wait('echo 1 > /sys/bus/workqueue/devices/writeback/cpumask')

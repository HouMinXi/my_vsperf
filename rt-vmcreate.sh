...
LOCATION="http://download.devel.redhat.com/released/RHEL-7/7.3/Server/x86_64/os/"
CPUS=3
DEBUG="no"
VIOMMU="NO"
DPDK_BUILD="NO"
...
# fix can't grep dpdk20 veriosn,http://download.devel.redhat.com/brewroot/packages/dpdk/20.11/1.el8fdb.3/x86_64/dpdk-20.11-1.el8fdb.3.x86_64.rpm
